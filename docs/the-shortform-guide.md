# The Shorthand Guide to Claude Fulcrum

![Header: Production-Ready - Tips & Tricks for Claude Code](./assets/images/shortform/00-header.png)

---

**Been an avid Claude Code user since the experimental rollout in Feb, building production applications entirely with Claude Code.**

Here's my complete setup after months of daily use: skills, hooks, subagents, MCPs, plugins, and what actually works.
...
*Built through months of daily Claude Code use and production application development*
