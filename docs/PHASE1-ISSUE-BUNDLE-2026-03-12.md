...
- `#423` Implement manifest-driven selective install profiles for Claude Fulcrum
- `#421` Add ECC install-state plus uninstall / doctor / repair lifecycle
- `#424` Define canonical session adapter contract for Claude Fulcrum 2.0 control plane
...
Implement manifest-driven selective install profiles for Claude Fulcrum
...
Define canonical session adapter contract for Claude Fulcrum 2.0 control plane
