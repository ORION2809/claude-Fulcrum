# The Longform Guide to Claude Fulcrum

![Header: The Longform Guide to Claude Fulcrum](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to Claude Fulcrum](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/ORION2809/claude-Fulcrum`
...
*Example of session storage -> <https://github.com/ORION2809/claude-Fulcrum/tree/main/examples/sessions>*
...
I've built these hooks and they're in the repo at `github.com/ORION2809/claude-Fulcrum/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/ORION2809/claude-Fulcrum/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [claude-fulcrum](https://github.com/ORION2809/claude-Fulcrum)*
