...
#### Ã¢ÂÅ’ Ã§Â»ÂÃ¥Â¯Â¹Ã¤Â¸ÂÃ¨Â¦ÂÃ¨Â¿â„¢Ã¦Â Â·Ã¥ÂÅ¡
...
#### Ã¢Å“â€¦ Ã¥Â§â€¹Ã§Â»Ë†Ã¨Â¿â„¢Ã¦Â Â·Ã¥ÂÅ¡
...
#### Ã¢ÂÅ’ Ã§Â»ÂÃ¥Â¯Â¹Ã¤Â¸ÂÃ¨Â¦ÂÃ¦â€¹Â¼Ã¦Å½Â¥ SQL
...
#### Ã¢Å“â€¦ Ã¥Â§â€¹Ã§Â»Ë†Ã¤Â½Â¿Ã§â€Â¨Ã¥Ââ€šÃ¦â€¢Â°Ã¥Å’â€“Ã¦Å¸Â¥Ã¨Â¯Â¢
...
```typescript
// Ã¢ÂÅ’ WRONG: localStorage (vulnerable to XSS)
localStorage.setItem('token', token)

// Ã¢Å“â€¦ CORRECT: httpOnly cookies
...
```typescript
// Ã¢ÂÅ’ WRONG: Logging sensitive data
console.log('User login:', { email, password })
console.log('Payment:', { cardNumber, cvv })

// Ã¢Å“â€¦ CORRECT: Redact sensitive data
...
```typescript
// Ã¢ÂÅ’ WRONG: Exposing internal details
catch (error) {
  return NextResponse.json(
...
// Ã¢Å“â€¦ CORRECT: Generic error messages
catch (error) {
