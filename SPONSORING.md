...
Claude Fulcrum is maintained as an open-source agent harness performance system across Claude Code, Cursor, OpenCode, and Codex app/CLI.
...
- npm downloads (`claude-fulcrum`, `ecc-agentshield`)
...
- GitHub Sponsors: [https://github.com/sponsors/ORION2809](https://github.com/sponsors/ORION2809)
- Project site: [https://github.com/ORION2809/claude-Fulcrum](https://github.com/ORION2809/claude-Fulcrum)
