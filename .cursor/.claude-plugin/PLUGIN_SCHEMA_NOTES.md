...
| `a7bc5f2` | REMOVE hooks | Users reported "duplicate hooks error"  |
| `779085e` | ADD hooks | Users reported "agents not loading"  |
| `e3a1306` | REMOVE hooks | Users reported "duplicate hooks error"  |
