/**
 * Claude Fulcrum (Claude Fulcrum) Plugin for OpenCode
 *
 ...
 * ```
 *
 * That enables the published plugin module only. for Claude Fulcrum commands, agents,
...
export const metadata = {
  name: "claude-fulcrum",
  version: VERSION,
  description: "Claude Fulcrum plugin for OpenCode",
