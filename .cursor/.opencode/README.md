...
> âš ï¸ This README is specific to OpenCode usage.  
> If you installed ECC via npm (e.g. `npm install opencode-ecc`), refer to the root README instead.

Claude Fulcrum (Claude Fulcrum) plugin for OpenCode - agents, commands, hooks, and skills.

## Installation

## Installation Overview

There are two ways to use Claude Fulcrum (Claude Fulcrum):
...
This loads the Claude Fulcrum OpenCode plugin module from npm:
