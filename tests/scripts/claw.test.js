 ...
 *
 * Tests the NanoClaw agent REPL module â€” storage, context, delegation, meta.
 *
...
// Test helper â€” matches ECC's custom test pattern
...
function runTests() {
  ...
  // â”€â”€ Storage tests (6) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Context tests (3) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  if (test('loadECCContext() concatenates multiple skill files', () => {
    // Use real skills from the Claude Fulcrum repo if they exist
    const skillsDir = path.join(process.cwd(), 'skills');
    if (!fs.existsSync(skillsDir)) {
      console.log('    (skipped â€” no skills/ directory in CWD)');
      return;
    }
    ...
    if (available.length < 2) {
      console.log('    (skipped â€” need 2+ skills with SKILL.md)');
      return;
    }
  ...
  // â”€â”€ Delegation tests (2) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  if (test('askClaude() handles subprocess error gracefully', () => {
    ...
    // If claude IS installed, we get an actual response â€” both are valid
    assert.ok(result.length > 0, 'Should return non-empty result');
  })) passed++; else failed++;

  // â”€â”€ REPL/Meta tests (3) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
