# Contributing to Claude Fulcrum
...
```bash
# 1. Fork and clone
gh repo fork ORION2809/claude-Fulcrum --clone
cd claude-fulcrum
...
- When contributing **agents** that answer docs/API questions, include the Context7 MCP tool names (e.g. `mcp__context7__resolve-library-id`, `mcp__context7__query-docs`) in the agent's tools and document the resolve â†’ query workflow.
...
Claude Fulcrum ships skill subsets for other harnesses:

- **Codex:** `.agents/skills/` â€” skills listed in `agents/openai.yaml` are loaded by Codex.
- **Cursor:** `.cursor/skills/` â€” a subset of skills is bundled for Cursor.
...
- **Issues:** [github.com/ORION2809/claude-Fulcrum/issues](https://github.com/ORION2809/claude-Fulcrum/issues)
- **X/Twitter:** @ORION2809
