...
Common issues and solutions for Claude Fulcrum (Claude Fulcrum) plugin.
...
# Reload plugin
# Claude Code â†’ Settings â†’ Extensions â†’ Reload
```
...
# Claude Code â†’ Extensions â†’ Claude Fulcrum â†’ Uninstall
...
1. **Check GitHub Issues**: [github.com/ORION2809/claude-Fulcrum/issues](https://github.com/ORION2809/claude-Fulcrum/issues)
